...
class Index extends Basic
{
    public function index()
    {
	    ...
	    $kefu9name = \think\Db::name('admin')->where('id', $kefu9id)->field('name')->cache($cachetime)->find();
		...
		//本月客服初诊排行
	    // 本月到店已维修
	    $kefu7ddywxmonth = $allusers->where('kefuid', $kefu7id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu8ddywxmonth = $allusers->where('kefuid', $kefu8id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu9ddywxmonth = $allusers->where('kefuid', $kefu9id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu10ddywxmonth = $allusers->where('kefuid', $kefu10id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu11ddywxmonth = $allusers->where('kefuid', $kefu11id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu12ddywxmonth = $allusers->where('kefuid', $kefu12id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    $kefu13ddywxmonth = $allusers->where('kefuid', $kefu13id)->where('daozhen', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    //初诊/月
	    ...
	    $kefu9czmonth = $allusers->where('kefuid', $kefu9id)->where('czfz', '1')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    ...
	    $kefu9fzmonth = $allusers->where('kefuid', $kefu9id)->where('czfz', '2')->where('dztime', 'between', [$monthtime, $tomorrowtime])->cache($cachetime)->count();
	    ...
	    $kefu9dz = $allusers->where('kefuid', $kefu9id)->where('daozhen', '1')->cache($cachetime)->count();
	    ...
	    $kefu9yy = $allusers->where('kefuid', $kefu9id)->where('yuyue', '1')->cache($cachetime)->count();
	    ...
	    $kefu9dj = $allusers->where('kefuid', $kefu9id)->cache($cachetime)->count();
	    ...
	    $this->assign([
		    'kefu7ddywxmonth' => $kefu7ddywxmonth,
		    'kefu8ddywxmonth' => $kefu8ddywxmonth,
		    'kefu9ddywxmonth' => $kefu9ddywxmonth,
		    'kefu10ddywxmonth' => $kefu10ddywxmonth,
		    'kefu11ddywxmonth' => $kefu11ddywxmonth,
		    'kefu12ddywxmonth' => $kefu12ddywxmonth,
		    'kefu13ddywxmonth' => $kefu13ddywxmonth,
		    'kefu7czmonth' => $kefu7czmonth,
		    'kefu8czmonth' => $kefu8czmonth,
		    'kefu9czmonth' => $kefu9czmonth,
